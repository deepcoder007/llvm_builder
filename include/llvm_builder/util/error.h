...
#ifndef LLVM_BUILDER_UTIL_ERROR_H_
...
#define CODEGEN_LINE(...)                                   \
    ::llvm_builder::SourceContext::update_top(__FILE__, __LINE__);   \
    __VA_ARGS__;                                                    \
/**/                                                         \

#define CODEGEN_MARK_NEXT_LINE                                   \
    ::llvm_builder::SourceContext::update_top(__FILE__, __LINE__ + 1);   \
/**/                                                             \
...
private:
    static std::vector<Error>& M_error_stack();
};

LLVM_BUILDER_NS_END

#endif // LLVM_BUILDER_UTIL_ERROR_H_
