...
#ifndef CORE_LLVM_BUILDER_FUNCTION_H_
#define CORE_LLVM_BUILDER_FUNCTION_H_
...
// TODO{vibhanshu}: except for FunctionBuilder class move everything in
//                  this file to core/llvm/builder/function.h
...
public:
    ...
    Function compile();
    void print(std::ostream& os) const;
    OSTREAM_FRIEND(FunctionBuilder)
