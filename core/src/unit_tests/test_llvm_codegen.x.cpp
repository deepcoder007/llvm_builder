...
TEST(LLVM_CODEGEN, type_test) {
    ...
    CORE_ALWAYS_ASSERT_EQ(int32_arr3_type, int32_arr3_alias_type);
    CORE_ALWAYS_ASSERT_EQ(int32_arr5_type, int32_arr5_alias_type);
    CORE_ALWAYS_ASSERT_NOT_EQ(int32_arr3_type, int32_arr5_type);
    CORE_ALWAYS_ASSERT_EQ(int32_type.size_in_bytes(), sizeof(int32_t));
    CORE_ALWAYS_ASSERT_EQ(bool_type.size_in_bytes(), 1);
    CORE_ALWAYS_ASSERT_EQ(int32_arr3_type.size_in_bytes(), sizeof(int32_t) * 3);
    CORE_ALWAYS_ASSERT_EQ(int32_arr5_type.size_in_bytes(), sizeof(int32_t) * 5);
    ...
    CORE_ALWAYS_ASSERT_EQ(int32_vec3_type, int32_vec3_alias_type);
    CORE_ALWAYS_ASSERT_EQ(int32_vec5_type, int32_vec5_alias_type);
    CORE_ALWAYS_ASSERT_NOT_EQ(int32_vec3_type, int32_vec5_type);
    CORE_ALWAYS_ASSERT_EQ(int32_vec3_type.size_in_bytes(), sizeof(int32_t) * 3u);
    CORE_ALWAYS_ASSERT_EQ(int32_vec5_type.size_in_bytes(), sizeof(int32_t) * 5u);
    CORE_ALWAYS_ASSERT_EQ(int32_vec5_ptr_type.size_in_bytes(), sizeof(int32_t*))
    ...
    CORE_ALWAYS_ASSERT(int32_arr3_str == int32_arr3_type.short_name());
    CORE_ALWAYS_ASSERT(int32_arr5_str == int32_arr5_type.short_name());
    CORE_ALWAYS_ASSERT(int32_vec3_str == int32_vec3_type.short_name());
    CORE_ALWAYS_ASSERT(int32_vec5_str == int32_vec5_type.short_name());
    CORE_ALWAYS_ASSERT(int32_arr3_str == int32_arr3_alias_type.short_name());
    CORE_ALWAYS_ASSERT(int32_arr5_str == int32_arr5_alias_type.short_name());
    CORE_ALWAYS_ASSERT(int32_vec3_str == int32_vec3_alias_type.short_name());
    CORE_ALWAYS_ASSERT(int32_vec5_str == int32_vec5_alias_type.short_name());
    CORE_ALWAYS_ASSERT(bool_str == bool_type.short_name());
    CORE_ALWAYS_ASSERT(int32_vec5_ptr_str == int32_vec3_type.pointer_type().short_name());

    {
        ...
        CORE_ALWAYS_ASSERT_EQ(4u, l_struct_type.num_elements());
        CORE_ALWAYS_ASSERT_EQ(l_struct_type[0].offset(), 0u);
        CORE_ALWAYS_ASSERT_EQ(l_struct_type[0].type().size_in_bytes(), 4u);
        CORE_ALWAYS_ASSERT_EQ(l_struct_type[1].offset(), 8u);
        CORE_ALWAYS_ASSERT_EQ(l_struct_type[1].type().base_type().size_in_bytes(), 20u);
        CORE_ALWAYS_ASSERT_EQ(l_struct_type[2].offset(), 16u);
        CORE_ALWAYS_ASSERT_EQ(l_struct_type[2].type().size_in_bytes(), 4u);
        CORE_ALWAYS_ASSERT_EQ(l_struct_type[3].offset(), 24u);
        CORE_ALWAYS_ASSERT_EQ(l_struct_type[3].type().base_type().size_in_bytes(), 20u);
    }
}
...
TEST(LLVM_CODEGEN, struct_array_type_test) {
    ...
    CODEGEN_LINE(TypeInfo int32_type = TypeInfo::mk_int32())
    CORE_ALWAYS_ASSERT(int32_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(not int32_type.is_valid_pointer_field())

    CODEGEN_LINE(TypeInfo int32_ptr_type = int32_type.pointer_type())
    CORE_ALWAYS_ASSERT(not int32_ptr_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(not int32_ptr_type.is_valid_pointer_field())

    CODEGEN_LINE(TypeInfo int32_arr3_type = TypeInfo::mk_array(int32_type, 3))
    CORE_ALWAYS_ASSERT(not int32_arr3_type.has_error())
    CORE_ALWAYS_ASSERT(not int32_arr3_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(not int32_arr3_type.is_valid_pointer_field())

    CODEGEN_LINE(TypeInfo int32_arr3_ptr_type = int32_arr3_type.pointer_type())
    CORE_ALWAYS_ASSERT(not int32_arr3_ptr_type.has_error())
    CORE_ALWAYS_ASSERT(int32_arr3_ptr_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(int32_arr3_ptr_type.is_valid_pointer_field())

    CODEGEN_LINE(TypeInfo int32_vec3_type = TypeInfo::mk_vector(int32_type, 3))
    CORE_ALWAYS_ASSERT(not int32_vec3_type.has_error())
    CORE_ALWAYS_ASSERT(not int32_vec3_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(not int32_vec3_type.is_valid_pointer_field())

    CODEGEN_LINE(TypeInfo int32_vec3_ptr_type = int32_vec3_type.pointer_type())
    CORE_ALWAYS_ASSERT(not int32_vec3_ptr_type.has_error())
    CORE_ALWAYS_ASSERT(int32_vec3_ptr_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(int32_vec3_ptr_type.is_valid_pointer_field())
    ...
    CORE_ALWAYS_ASSERT(not l_struct_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(not l_struct_type.is_valid_pointer_field())
    CODEGEN_LINE(TypeInfo struct_ptr_type = l_struct_type.pointer_type())
    CORE_ALWAYS_ASSERT(not struct_ptr_type.has_error())
    CORE_ALWAYS_ASSERT(struct_ptr_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(struct_ptr_type.is_valid_pointer_field())

    CODEGEN_LINE(TypeInfo struct_ptr_arr3_type = TypeInfo::mk_array(struct_ptr_type, 3))
    CORE_ALWAYS_ASSERT(not struct_ptr_arr3_type.has_error())
    CORE_ALWAYS_ASSERT(not struct_ptr_arr3_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(not struct_ptr_arr3_type.is_valid_pointer_field())

    CODEGEN_LINE(TypeInfo struct_ptr_arr3_ptr_type = struct_ptr_arr3_type.pointer_type())
    CORE_ALWAYS_ASSERT(not struct_ptr_arr3_ptr_type.has_error())
    CORE_ALWAYS_ASSERT(struct_ptr_arr3_ptr_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(struct_ptr_arr3_ptr_type.is_valid_pointer_field())
    ...
    CORE_ALWAYS_ASSERT(not l_outer_struct_type.has_error())
    CORE_ALWAYS_ASSERT(not l_outer_struct_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(not l_outer_struct_type.is_valid_pointer_field())

    CODEGEN_LINE(TypeInfo outer_struct_ptr_type = l_outer_struct_type.pointer_type())
    CORE_ALWAYS_ASSERT(not outer_struct_ptr_type.has_error())
    CORE_ALWAYS_ASSERT(outer_struct_ptr_type.is_valid_struct_field())
    CORE_ALWAYS_ASSERT(outer_struct_ptr_type.is_valid_pointer_field())
}
...
TEST(LLVM_CODEGEN, basic_test) {
    ...
    CODEGEN_LINE(Module::Context l_module_ctx{l_module})
    {
...

        {
            ...
            CODEGEN_LINE(ValueInfo res4 = res2.add(ctx.field("arg3").load(), "add_arg"))
    ...
    }
    {
        ...
        CORE_ASSERT(not int32_type.has_error());
        {
            ...
            CODEGEN_LINE(ValueInfo compare_1 = arg_b.less_than(c_5, "comp_test"))
            CORE_ALWAYS_ASSERT(bool_type.check_sync(compare_1));
            CODEGEN_LINE(ValueInfo compare_2 = compare_1.not_equal(ValueInfo::from_constant(false), "if_cond"))
            CORE_ALWAYS_ASSERT(bool_type.check_sync(compare_2));
            ...
            if_else_branch.then_branch([&ctx_if_else] {
                ...
                ValueInfo then_val = arg_a.add(ValueInfo::from_constant(999), "then_add_tmp");
                then_val.push("test_value_fwd"_cs);
                ValueInfo then_val_2 = then_val.add(then_val, "double_then");
                then_val_2.push("test_value_fwd_2"_cs);
            });
            if_else_branch.else_branch([&ctx_if_else] {
                ValueInfo arg_a = ctx_if_else.field("a").load();
                ValueInfo else_val = arg_a.add(ValueInfo::from_constant(8080), "else_add_tmp");
                else_val.push("test_value_fwd"_cs);
                ValueInfo else_val_2 = else_val.add(else_val, "double_then");
    ...
    }
    {
        ...
        CODEGEN_LINE(const RuntimeStruct& l_args3_struct = l_runtime_module.struct_info("args3"))
        CODEGEN_LINE(const RuntimeStruct& l_abc_struct = l_runtime_module.struct_info("abc_args"))
        CORE_ALWAYS_ASSERT(not l_runtime_module.has_error());
        CODEGEN_LINE(const RuntimeEventFn& sample_fn = l_runtime_module.event_fn_info("sample_fn_name"))
        CORE_ALWAYS_ASSERT(not sample_fn.has_error());
        CODEGEN_LINE(const RuntimeEventFn& if_else_fn = l_runtime_module.event_fn_info("foo_if_else"))
        CORE_ALWAYS_ASSERT(not if_else_fn.has_error());

        {
            for (int32_t i = 0; i != 10; ++i) {
                CODEGEN_LINE(RuntimeObject l_args_obj = l_args3_struct.mk_object())
        ...
        {
            for (int32_t i = 0; i != 10; ++i) {
                CODEGEN_LINE(RuntimeObject l_abc_obj = l_abc_struct.mk_object())
                ...
                CORE_ALWAYS_ASSERT_EQ(test_value_fwd_2, result);
            }
        }
    }
}
...
TEST(LLVM_CODEGEN, lexical_context) {
    ...
    CORE_ASSERT(not ErrorContext::has_error());
    {
        ...
        CODEGEN_LINE(const RuntimeNamespace& l_runtime_module = jit_runner.get_global_namespace())
        CODEGEN_LINE(const RuntimeStruct& l_lexical_struct = l_runtime_module.struct_info("lexical_args"))
        CORE_ALWAYS_ASSERT(not l_runtime_module.has_error());

        CODEGEN_LINE(const RuntimeEventFn& fn1 = l_runtime_module.event_fn_info("fn1"))
        CODEGEN_LINE(const RuntimeEventFn& fn2 = l_runtime_module.event_fn_info("fn2"))
        CODEGEN_LINE(const RuntimeEventFn& fn3 = l_runtime_module.event_fn_info("fn3"))
        CODEGEN_LINE(const RuntimeEventFn& fn4 = l_runtime_module.event_fn_info("fn4"))
        CORE_ALWAYS_ASSERT(not fn1.has_error());
        CORE_ALWAYS_ASSERT(not fn2.has_error());
        CORE_ALWAYS_ASSERT(not fn3.has_error());
        CORE_ALWAYS_ASSERT(not fn4.has_error());

        for (int32_t i = 0; i != 10; ++i) {
            CODEGEN_LINE(RuntimeObject l_args_obj = l_lexical_struct.mk_object())
            ...
            CORE_ALWAYS_ASSERT_EQ(i + 2, fn1.on_event(l_args_obj));
            CORE_ALWAYS_ASSERT_EQ(i + 2, fn2.on_event(l_args_obj));
            CORE_ALWAYS_ASSERT_EQ(i + 1, fn3.on_event(l_args_obj));
            CORE_ALWAYS_ASSERT_EQ(i, fn4.on_event(l_args_obj));
        }
    }
}
...
TEST(LLVM_CODEGEN, struct_type_test) {
    ...
    CORE_ALWAYS_ASSERT(not struct_test_args_type.has_error());
    ...
    CODEGEN_LINE(const RuntimeNamespace& l_runtime_module = jit_runner.get_global_namespace())
    CODEGEN_LINE(const RuntimeStruct& l_test_struct_rt = l_runtime_module.struct_info("test_struct"))
    CODEGEN_LINE(const RuntimeStruct& l_args_struct = l_runtime_module.struct_info("struct_test_args"))
    CODEGEN_LINE(const RuntimeEventFn& struct_fn = l_runtime_module.event_fn_info("struct_fn"))
    CORE_ALWAYS_ASSERT(not l_runtime_module.has_error());
    CORE_ALWAYS_ASSERT(not l_test_struct_rt.has_error());
    CORE_ALWAYS_ASSERT(not l_args_struct.has_error());
    CORE_ALWAYS_ASSERT(not struct_fn.has_error());

    CORE_ALWAYS_ASSERT_EQ(l_test_struct_rt.size_in_bytes(), 20);
    CORE_ALWAYS_ASSERT_EQ(l_test_struct_rt["field_1"].offset(), 0);
    CORE_ALWAYS_ASSERT_EQ(l_test_struct_rt["field_2"].offset(), 4);
    CORE_ALWAYS_ASSERT_EQ(l_test_struct_rt["field_3"].offset(), 8);
    CORE_ALWAYS_ASSERT_EQ(l_test_struct_rt["field_4"].offset(), 12);
    CORE_ALWAYS_ASSERT_EQ(l_test_struct_rt["field_5"].offset(), 16);
    CORE_ALWAYS_ASSERT_EQ(l_test_struct_rt.num_fields(), 5);

    CODEGEN_LINE(RuntimeField field_1 = l_test_struct_rt["field_1"])
    CODEGEN_LINE(RuntimeField field_2 = l_test_struct_rt["field_2"])
    CORE_ALWAYS_ASSERT(not field_1.has_error());
    CORE_ALWAYS_ASSERT(not field_2.has_error());
    CORE_ALWAYS_ASSERT_EQ(field_1.idx(), 0);
    CORE_ALWAYS_ASSERT_EQ(field_2.idx(), 1);
    {
        CODEGEN_LINE(RuntimeObject l_test_object = l_test_struct_rt.mk_object())
        ...
        CORE_ALWAYS_ASSERT_EQ(l_test_object.get<int32_t>("field_1"), 100);
        CORE_ALWAYS_ASSERT_EQ(l_test_object.get<int32_t>("field_2"), 200);
        CORE_ALWAYS_ASSERT_EQ(l_test_object.get<int32_t>("field_3"), 300);
        CORE_ALWAYS_ASSERT_EQ(l_test_object.get<int32_t>("field_4"), 400);
    }
    {
        for (int32_t i = 0; i != 10; ++i) {
            CODEGEN_LINE(RuntimeObject l_test_obj = l_test_struct_rt.mk_object())
            l_test_obj.try_freeze();
            CODEGEN_LINE(RuntimeObject l_args_obj = l_args_struct.mk_object())
            CORE_ALWAYS_ASSERT(not l_test_obj.has_error());
            CORE_ALWAYS_ASSERT(l_test_obj.is_instance_of(l_test_struct_rt));
            int32_t result = 0;
            {
                l_args_obj.set<int32_t>("arg1", i);
            ...
            {
                CORE_ALWAYS_ASSERT_EQ(l_test_obj.get<int32_t>("field_1"), i);
                CORE_ALWAYS_ASSERT_EQ(l_test_obj.get<int32_t>("field_2"), i + 2);
                CORE_ALWAYS_ASSERT_EQ(l_test_obj.get<int32_t>("field_3"), i + 4);
                CORE_ALWAYS_ASSERT_EQ(l_test_obj.get<int32_t>("field_4"), i + 6);
            }
            CORE_ALWAYS_ASSERT_EQ(result, i + 2);
        }
    }
}
...
TEST(LLVM_CODEGEN, multi_type) {
    ...
    JustInTimeRunner jit_runner;
    {
        ...
        Module::Context l_module_ctx{l_module};
        {
            ...
            Function fn = fn_builder.compile();
            {
                ...
                arg5.field("int16_arg1").store(arg1.cast(int16_type, "int16_typecast"));
                arg5.field("int64_arg1").store(arg1.cast(int64_type, "int64_typecast"));
                arg5.field("int16_arg2").store(arg1_neg.cast(int16_type, "int16_typecast"));
                arg5.field("int64_arg2").store(arg1_neg.cast(int64_type, "int64_typecast"));
                arg5.field("uint16_arg2").store(arg1_neg.cast(uint16_type, "uint16_typecast"));
                arg5.field("uint64_arg2").store(arg1_neg.cast(uint64_type, "uint64_typecast"));
                arg5.field("float32_arg2").store(arg4.cast(float32_type, "float32_type_cast"));
                arg5.field("float64_arg2").store(arg3.cast(float64_type, "float64_type_cast"));
    ...
    CODEGEN_LINE(const RuntimeNamespace& l_runtime_module = jit_runner.get_global_namespace())
    CODEGEN_LINE(const RuntimeStruct& l_output_struct = l_runtime_module.struct_info("multi_type_struct"))
    CODEGEN_LINE(const RuntimeStruct& l_args_struct = l_runtime_module.struct_info("multi_type_args"))
    CODEGEN_LINE(const RuntimeEventFn& multi_type_fn = l_runtime_module.event_fn_info("basic_multi_type_test"))
    CORE_ALWAYS_ASSERT(not l_runtime_module.has_error());
    CORE_ALWAYS_ASSERT(not multi_type_fn.has_error());

    {
        for (int32_t i = 0; i != 10; ++i) {
            CODEGEN_LINE(RuntimeObject l_output_obj = l_output_struct.mk_object())
            ...
            {
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<int32_t>("int_arg1"), i);
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<uint32_t>("uint_arg1"), (uint32_t)(i + 2));
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<float32_t>("float32_arg1"), (float32_t)(i + 4));
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<float64_t>("float64_arg1"), (float64_t)(i + 6));
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<int16_t>("int16_arg1"), (int16_t)i);
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<int64_t>("int64_arg1"), (int64_t)i);
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<int16_t>("int16_arg2"), (int16_t)(i * -1));
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<int64_t>("int64_arg2"), (int64_t)(i * -1));
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<uint16_t>("uint16_arg2"), (uint16_t)(i * -1));
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<uint64_t>("uint64_arg2"), (uint64_t)((uint32_t)(i * -1)));
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<float32_t>("float32_arg2"), (float32_t)(float64_t)(i + 6));
                CORE_ALWAYS_ASSERT_EQ(l_output_obj.get<float64_t>("float64_arg2"), (float64_t)(float32_t)(i + 4));
            }
        }
    }
}
...
TEST(LLVM_CODEGEN, array_type_test) {
    ...
    INIT_MODULE(l_module)
    {
        ...
        CODEGEN_LINE(const RuntimeNamespace& l_runtime_module = jit_runner.get_global_namespace())
        CODEGEN_LINE(const RuntimeStruct& l_arr_load_struct = l_runtime_module.struct_info("arr_load_args"))
        CODEGEN_LINE(const RuntimeStruct& l_arr_assign_struct = l_runtime_module.struct_info("arr_assign_args"))
        CODEGEN_LINE(const RuntimeStruct& l_vec_load_struct = l_runtime_module.struct_info("vec_load_args"))
        CODEGEN_LINE(const RuntimeStruct& l_vec_assign_struct = l_runtime_module.struct_info("vec_assign_args"))
        CORE_ALWAYS_ASSERT(not l_runtime_module.has_error());

        CODEGEN_LINE(const RuntimeEventFn& arr_idx_load_fn = l_runtime_module.event_fn_info("array_idx_load"))
        CODEGEN_LINE(const RuntimeEventFn& arr_idx_load_lazy_fn = l_runtime_module.event_fn_info("array_idx_load_lazy"))
        CODEGEN_LINE(const RuntimeEventFn& arr_idx_assign_fn = l_runtime_module.event_fn_info("array_idx_assign"))
        CODEGEN_LINE(const RuntimeEventFn& arr_idx_assign_lazy_fn = l_runtime_module.event_fn_info("array_idx_assign_lazy"))
        CODEGEN_LINE(const RuntimeEventFn& vec_idx_load_fn = l_runtime_module.event_fn_info("vector_idx_load"))
        CODEGEN_LINE(const RuntimeEventFn& vec_idx_assign_fn = l_runtime_module.event_fn_info("vector_idx_assign"))
        CORE_ALWAYS_ASSERT(not arr_idx_load_fn.has_error());
        CORE_ALWAYS_ASSERT(not arr_idx_load_lazy_fn.has_error());
        CORE_ALWAYS_ASSERT(not arr_idx_assign_fn.has_error());
        CORE_ALWAYS_ASSERT(not arr_idx_assign_lazy_fn.has_error());
        CORE_ALWAYS_ASSERT(not vec_idx_load_fn.has_error());
        CORE_ALWAYS_ASSERT(not vec_idx_assign_fn.has_error());

        {
            CODEGEN_LINE(RuntimeArray arr_obj = RuntimeArray::from(runtime_type_t::int32, 10))
            for (uint32_t i = 0; i != 10; ++i) {
                arr_obj.set<int32_t>(i, (int32_t)(i+1) * 10);
            }
            arr_obj.try_freeze();
            for (int32_t i = 0; i != 5; ++i) {
                CODEGEN_LINE(RuntimeObject l_args_obj = l_arr_load_struct.mk_object())
                l_args_obj.set<int32_t>("a", i);
                l_args_obj.set_array("b", arr_obj);
                l_args_obj.try_freeze();
                CODEGEN_LINE(int32_t result = arr_idx_load_fn.on_event(l_args_obj))
                CORE_ALWAYS_ASSERT_EQ(result, arr_obj.get<int32_t>(i));
            }
        }
        {
            CODEGEN_LINE(RuntimeArray arr_obj = RuntimeArray::from(runtime_type_t::int32, 10))
        ...
        }
        {
            ...
            arr_obj.try_freeze();
            for (int32_t i = 0; i != 5; ++i) {
                CODEGEN_LINE(RuntimeObject l_args_obj = l_arr_assign_struct.mk_object())
            ...
            for (int32_t i = 0; i != 5; ++i) {
                CORE_ALWAYS_ASSERT_EQ(arr_obj.get<int32_t>(static_cast<uint32_t>(i)), i * 100);
            }
        }
        {
            CODEGEN_LINE(RuntimeArray arr_obj = RuntimeArray::from(runtime_type_t::int32, 10))
        ...
        }
        {
            ...
            arr_obj.try_freeze();
            for (int32_t i = 0; i != 5; ++i) {
                CODEGEN_LINE(RuntimeObject l_args_obj = l_vec_load_struct.mk_object())
                l_args_obj.set<int32_t>("a", i);
                l_args_obj.set_array("b", arr_obj);
                l_args_obj.try_freeze();
                // TODO{vibhanshu}: enable and debug this test on vector
                CODEGEN_LINE(int32_t result = vec_idx_load_fn.on_event(l_args_obj))
                CORE_ALWAYS_ASSERT_EQ(result, arr_obj.get<int32_t>(static_cast<uint32_t>(i)));
            }
        }
        {
            CODEGEN_LINE(RuntimeArray arr_obj = RuntimeArray::from(runtime_type_t::int32, 10))
            arr_obj.try_freeze();
            for (int32_t i = 0; i != 5; ++i) {
                CODEGEN_LINE(RuntimeObject l_args_obj = l_vec_assign_struct.mk_object())
                l_args_obj.set<int32_t>("idx", i);
...
TEST(LLVM_CODEGEN, vector_type_test) {
    ...
    JustInTimeRunner jit_runner;
    {
        ...
        Module::Context l_module_ctx{l_module};
        {
...

            {
                ...
                ValueInfo arg3 = ctx.field("arg3").load();
                ValueInfo l_sum_vec = arg1.add(arg2, "construct_add");
                ValueInfo l_sum_vec_2 = l_sum_vec.add(l_sum_vec, "double_res");
    ...
    CODEGEN_LINE(const RuntimeNamespace& l_runtime_module = jit_runner.get_global_namespace())
    CODEGEN_LINE(const RuntimeStruct& l_vec_add_struct = l_runtime_module.struct_info("vec_add_args"))
    CODEGEN_LINE(const RuntimeStruct& l_vec_set_struct = l_runtime_module.struct_info("vec_set_args"))
    CODEGEN_LINE(const RuntimeStruct& l_vec_load_struct = l_runtime_module.struct_info("vec_load_args"))
    CODEGEN_LINE(const RuntimeEventFn& vec_add_fn = l_runtime_module.event_fn_info("sample_vec_add_op"))
    CODEGEN_LINE(const RuntimeEventFn& vec_set_fn = l_runtime_module.event_fn_info("set_vector_value_idx1"))
    CODEGEN_LINE(const RuntimeEventFn& vec_load_fn = l_runtime_module.event_fn_info("load_vector_value_idx1"))
    CORE_ALWAYS_ASSERT(not l_runtime_module.has_error());
    CORE_ALWAYS_ASSERT(not vec_add_fn.has_error());
    CORE_ALWAYS_ASSERT(not vec_set_fn.has_error());
    CORE_ALWAYS_ASSERT(not vec_load_fn.has_error());

    {
        for (int32_t i = 0; i != 10; ++i) {
            CODEGEN_LINE(RuntimeArray arr1_obj = RuntimeArray::from(runtime_type_t::int32, 10))
            CODEGEN_LINE(RuntimeArray arr2_obj = RuntimeArray::from(runtime_type_t::int32, 10))
            CODEGEN_LINE(RuntimeArray arr3_obj = RuntimeArray::from(runtime_type_t::int32, 10))
            ...
            CODEGEN_LINE(RuntimeObject l_args_obj = l_vec_add_struct.mk_object())
            ...
            CORE_ALWAYS_ASSERT_EQ(arr3_obj.get<int32_t>(0), (4 * (i + 0) + 12));
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(1) == (4 * (i + 1) + 12));
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(2) == (4 * (i + 2) + 12));
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(3) == (4 * (i + 3) + 12));
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(4) == (4 * (i + 4) + 12));
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(5) == 0);
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(6) == 0);
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(7) == 0);
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(8) == 0);
            CORE_ALWAYS_ASSERT(arr3_obj.get<int32_t>(9) == 0);
        }
    }
    {
        for (int32_t i = 0; i != 10; ++i) {
            ...
            arr_obj.try_freeze();
            CODEGEN_LINE(RuntimeObject l_args_obj = l_vec_set_struct.mk_object())
            l_args_obj.set_array("arg1", arr_obj);
            l_args_obj.set<int32_t>("v", i * 10);
            l_args_obj.try_freeze();
            CODEGEN_LINE(vec_set_fn.on_event(l_args_obj))
            CORE_ALWAYS_ASSERT(arr_obj.get<int32_t>(1) == i * 10);
        }
    }
    {
        for (int32_t i = 0; i != 10; ++i) {
            ...
            CORE_ALWAYS_ASSERT_EQ(result, i * 100 + 1);
        }
    }
}
...
TEST(LLVM_CODEGEN, multi_module) {
    ...
    CODEGEN_LINE(l_cursor.bind())
    {
        ...
        Module::Context l_module_ctx{l_module};
        {
            ...
            Function fn = fn_builder.compile();
            {
                ...
                ValueInfo res = arg1.add(arg2, "construct_add");
                ValueInfo res2 = res.add(c1, "add_const1");
                ValueInfo res3 = res2.add(c2, "add_const1");
                ValueInfo res4 = res2.add(ctx.field("arg3").load(), "add_arg");
                ValueInfo res5 = res3.add(res4, "accum_res");
    ...
    }
    {
        ...
        TypeInfo float32_type = TypeInfo::mk_float32();
        {
            ...
            Function fn = fn_builder.compile();
            {
                ...
                ValueInfo res = arg.add(arg, "construct_add");
    ...
    CODEGEN_LINE(const RuntimeNamespace& l_runtime_module = jit_runner.get_global_namespace())
    CODEGEN_LINE(const RuntimeStruct& l_multi_struct = l_runtime_module.struct_info("multi_args"))
    CODEGEN_LINE(const RuntimeEventFn& fn1_fn = l_runtime_module.event_fn_info("fn1"))
    CORE_ALWAYS_ASSERT(not l_runtime_module.has_error());
    CORE_ALWAYS_ASSERT(not fn1_fn.has_error());
    CORE_ALWAYS_ASSERT(fn1_fn.is_init());

    {
        const int32_t golden_set[10] = { 2410, 2420, 2430, 2440, 2450,
                                      2460, 2470, 2480, 2490, 2500};
        for (int32_t i = 0; i != 10; ++i) {
            CODEGEN_LINE(RuntimeObject l_args_obj = l_multi_struct.mk_object())
            l_args_obj.set<int32_t>("arg1", i);
            l_args_obj.set<int32_t>("arg2", i + 1);
            l_args_obj.set<int32_t>("arg3", i + 2);
            l_args_obj.try_freeze();
            CODEGEN_LINE(int32_t result = fn1_fn.on_event(l_args_obj))
            CORE_ALWAYS_ASSERT_EQ(golden_set[i] * 2, result);
        }
    }
}
...
TEST(LLVM_CODEGEN, resilient_api) {
    ...
    auto gen_fn = [&int32_type] (const FnContext& fn_context, const std::string& fn_name, Module& mod, int version) -> Function {
        ...
        CODEGEN_LINE(Function fn = fn_builder.compile())
        {
            ...
            if (version == 0) {
                CORE_ASSERT(not l_fn_body.is_sealed());
                CORE_ASSERT(not l_fn_body.is_commit());
                CODEGEN_LINE(CodeSectionContext::set_return_value(CodeSectionContext::pop("arg_in"_cs)))
                CORE_ASSERT(l_fn_body.is_sealed());
                CORE_ASSERT(l_fn_body.is_commit());
            }
    ...
    CODEGEN_LINE(Module::Context l_module_ctx{l_module})
    CORE_ASSERT(fn_save.has_error());
    fn_save = gen_fn(fn_context, "fn1", l_module, 0);
    CORE_ASSERT(not fn_save.has_error());
    ...
    CODEGEN_LINE(const RuntimeNamespace& l_runtime_module = jit_runner.get_global_namespace())
    CODEGEN_LINE(const RuntimeStruct& l_resilient_struct = l_runtime_module.struct_info("resilient_args"))
    CODEGEN_LINE(const RuntimeEventFn& fn1_fn = l_runtime_module.event_fn_info("fn1"))
    CODEGEN_LINE(const RuntimeEventFn& fn2_fn = l_runtime_module.event_fn_info("fn2"))
    CODEGEN_LINE(const RuntimeEventFn& fn3_fn = l_runtime_module.event_fn_info("fn3"))
    CODEGEN_LINE(const RuntimeEventFn& fn4_fn = l_runtime_module.event_fn_info("fn4"))
    CORE_ALWAYS_ASSERT(not l_runtime_module.has_error());
    CORE_ALWAYS_ASSERT(not fn1_fn.has_error());
    CORE_ALWAYS_ASSERT(not fn2_fn.has_error());
    CORE_ALWAYS_ASSERT(not fn3_fn.has_error());
    CORE_ALWAYS_ASSERT(not fn4_fn.has_error());

    for (int32_t i = 0; i != 10; ++i) {
        CODEGEN_LINE(RuntimeObject l_args_obj = l_resilient_struct.mk_object())
        l_args_obj.set<int32_t>("arg1", i);
        l_args_obj.set<int32_t>("arg2", i + 1);
        l_args_obj.set<int32_t>("arg3", i + 2);
        l_args_obj.try_freeze();

        CORE_ALWAYS_ASSERT_EQ(i + 2, fn1_fn.on_event(l_args_obj));
        CORE_ALWAYS_ASSERT_EQ(i + 2, fn2_fn.on_event(l_args_obj));
        CORE_ALWAYS_ASSERT_EQ(i + 1, fn3_fn.on_event(l_args_obj));
        CORE_ALWAYS_ASSERT_EQ(i, fn4_fn.on_event(l_args_obj));
    }
}
